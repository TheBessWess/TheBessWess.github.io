function moveScenery() {
    ...
    for (var i = 0; i < scenery.building.instances.length; i++) {
        ...
        // Move building back to the right when it leaves the screen
    ...
    for (var i = 0; i < scenery.lamp.instances.length; i++) {
        ...
        // Move lamp back to the right when it leaves the screen
...
function triggerLevelTransition() {
    ...
    // Check if the player has finished every level
